    ...
    <div>
      <header>
        <nav className="flex p-4 gap-1 ">
          ...
          <div onClick={() => setMyClass(myClass == "hidden" ? "block flex flex-col items-center justify-center gap-12" : "hidden")} className="my-auto ml-auto mr-2 cursor-pointer md:hidden"><i className='bx bx-md bx-menu'></i></div>
        </nav>
